...
│
├── data/
│   └── Grades-6.csv            # Dataset source
│   └── resultados_modelo.csv
│
├── notebook/
│   └── modelo-student.ipynb    # EDA, feature engineering, modeling
│
├── powerbi/
...
> This project focuses on bridging: **Machine Learning + Business Visualization**
